...
#Les différents paramètres
    f1 = pd.read_csv("secteurSud_2005.csv", delimiter=';')
    f2 = pd.read_csv("RegionSud2005lat-21.335_long55.612.csv", delimiter=';')
...
#Ajouter au fichier l'évaluation du facteur de transposition
...
max_value = f4.loc[f4['FactTrans'] == f4['FactTrans'].max()].index.item()
print(f4[max_value:max_value + 1])
